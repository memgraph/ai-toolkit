...
parser = argparse.ArgumentParser(description="Convert a text file to a CSV file with one line per row.")
...
with open(txt_file_path, "r", encoding="utf-8") as txt_file, open(csv_file_path, "w", encoding="utf-8") as csv_file:
