...
| Gemini CLI | `GeminiCLIHooksAdapter` | Command receives one JSON object on `stdin` |
...
Codex and Claude Code have distributable Runtime Plugins. Gemini CLI, Copilot
CLI, Cursor, and OpenCode use project-local wiring generated by `hook init`:
