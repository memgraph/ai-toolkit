    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    def from_llm(
        ...
        *,
        ...
        qa_llm: BaseLanguageModel | Any | None = None,
        ...
        **kwargs: Any,
        ...
        if use_function_response:
            try:
                ...
                raise ValueError("Provided LLM does not support native tools/functions") from e
        else:
    ...
    def _call(
        ...
        context = self.graph.query(generated_cypher)[: self.top_k] if generated_cypher else []
